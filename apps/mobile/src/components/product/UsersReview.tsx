...
import type { UsersReviewsProps } from "./types";

export default function UsersReviews({ rate }: UsersReviewsProps) {
  return (
    <View
      style={{
        padding: 30,
